...
[SmallRye Implementation](https://github.com/smallrye/smallrye-open-api) extend this with some extra features, and support for more web frameworks, in Quarkus. 
...
we will already have a Schema document under generated `/openapi`
...
See https://quarkus.io/guides/rest-json for more information.
...
We added support in SmallRye to auto generate this using either the method name, class and method name, or package, class and method name. To do this add 
the following to `application.properties`:
...
See https://quarkus.io/guides/openapi-swaggerui for more information.
...
further describe your Spring Web Endpoints. For Example:
...
See https://quarkus.io/guides/spring-web for more information.
...
and can be further described using MicroProfile OpenAPI. To add a Vert.x reactive Route to Quarkus, you need the following in your `pom.xml`:
...
See https://quarkus.io/guides/reactive-routes for more information.
...
See https://quarkus.io/guides/rest-data-panache for more information.
...
In Quarkus, Swagger-UI is included by default and when you now browse to http://localhost:8080/swagger-ui you will see the UI with all your endpoints:
